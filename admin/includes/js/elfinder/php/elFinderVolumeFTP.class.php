...
class elFinderVolumeFTP extends elFinderVolumeDriver {
	...
	protected function _relpath($path) {
		$r = $path == $this->root ? '' : substr($path, strlen($this->root));
		//AKHelper::_('system.mark', '_relpath '.$r, 'WindWalker') ;
		$r = trim($r, '/');
		return $r ;
	}
	...
	protected function _abspath($path) {
		$r = $path == $this->separator ? $this->root : trim($this->root, '/').$this->separator.$path;
		//AKHelper::_('system.mark', '_abpath '.$r, 'WindWalker') ;
		return $r ;
	}
	...
	protected function _path($path) {
		$r = $this->rootName.($path == $this->root ? '' : $this->separator.$this->_relpath($path));
		//AKHelper::_('system.mark', '_path '.$r, 'WindWalker') ;
		return $r ;
	}
	...
	protected function _inpath($path, $parent) {
		$r = $path == $parent || strpos($path, $parent.'/') === 0;
		//AKHelper::_('system.mark', '_inpath '.$r, 'WindWalker') ;
		return $r ;
	}
	...
	protected function getScandir($path) {
		...
		$files = ftp_nlist($this->connect,$path);
