CREATE TABLE IF NOT EXISTS `#__remoteimage_managers` (
...
INSERT INTO `#__remoteimage_managers` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `catid`, `title`, `alias`, `url`, `introtext`, `fulltext`, `images`, `version`, `created`, `created_by`, `modified`, `modified_by`, `ordering`, `published`, `publish_up`, `publish_down`, `checked_out`, `checked_out_time`, `access`, `language`, `params`) VALUES
