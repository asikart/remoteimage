...
?>
<form action="<?php echo JRoute::_('index.php?option=com_remoteimage&view=managers'); ?>" method="post" name="adminForm" id="adminForm">

	<div id="remoteimage-wrap" class="windwalker list container-fluid managers<?php echo $data->params->get('pageclass_sfx'); ?>">
		<div id="remoteimage-wrap-inner">
			...
			<?php if ($data->params->get('show_description', 1) || $data->params->def('show_description_image', 1)) : ?>
				<div class="category-desc">
					...
					{
						echo JHtml::_('content.prepare', $data->category->description, '', 'com_remoteimage.category');
					}
					?>
					<div class="clr"></div>
				</div>
